...
echo "aplay -Dhw:0,0 %1/aplay -Dplughw:ArrayUAC10,0 %1" | sudo tee -a /etc/mycroft/mycroft.conf > /dev/null
echo "mpg123 -a hw:0,0 %1/mpg123 -a plughw:ArrayUAC10,0 %1" | sudo tee -a /etc/mycroft/mycroft.conf > /dev/null
